 ...
 * </pre>
 *
 * @see <a href="https://github.com/artclarke/humble-video">...</a>
 * @see <a href="https://github.com/artclarke/humble-video/blob/master/humble-video-demos/src/main/java/io/humble/video/demos/RecordAndEncodeVideo.java">...</a>
 * @author aclarke
 */
public class RecordAndEncodeVideo {
    ...
    private static void recordScreen(String filename, String formatname, String codecname, int duration, int snapsPerSecond) throws AWTException, InterruptedException, IOException {
        ...
        // use
        final PixelFormat.Type pixelformat = PixelFormat.Type.PIX_FMT_VDPAU_H264;
