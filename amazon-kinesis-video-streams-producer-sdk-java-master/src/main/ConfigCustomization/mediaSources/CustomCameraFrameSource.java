...
public class CustomCameraFrameSource {
        ...
        private final Log log = LogFactory.getLog(mediaSources.CustomCameraFrameSource.class);
        private long durationInMillis = 0;
        private int frameIndex = 0;
        private long frameStartMillis = 0;
        private List<String> fileNames = new ArrayList<>();

        public CustomCameraFrameSource(final CameraMediaSourceConfiguration configuration) {
